...
class __TwigTemplate_b81792e2ad1bac58c1b6be08ded8ca08ff5abe064a740be8c68d7d14a5a2a589 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"example-wrapper\">
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["regions"]) || array_key_exists("regions", $context) ? $context["regions"] : (function () { throw new RuntimeError('Variable "regions" does not exist.', 15, $this->source); })()));
    ...
    <tr>
        ...
        <td>
            ";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["region"], "presentation", [], "any", false, false, false, 22), "html", null, true);
            echo "
        </td>
        <td><a href=\"";
            // line 24
...
";
    ...
    {
        return array (  137 => 31,  128 => 27,  120 => 24,  115 => 22,  109 => 19,  104 => 16,  99 => 15,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"example-wrapper\">
    ...
    <tr>
        ...
        <td><a href=\"{{ path('region_show', {'id': region.id}) }}\">show</a></td>
    </tr>
    {% else %}
        <tr>
            <td colspan=\"6\">no records found</td>
...
{% endblock %}
", "region/index.html.twig", "/home/serandour/couette_et_café/agvoy-app-03/templates/region/index.html.twig");
    }
}
