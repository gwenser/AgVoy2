...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/login'), [0 => 'ROLE_ANONYMOUS'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/super_admin'), [0 => 'ROLE_SUPER_ADMIN'], NULL);
...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/owner'), [0 => 'ROLE_OWNER'], NULL);
