...
// Returns the private 'App\Repository\IndisponibilityRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/IndisponibilityRepository.php';

return $this->privates['App\\Repository\\IndisponibilityRepository'] = new \App\Repository\IndisponibilityRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
